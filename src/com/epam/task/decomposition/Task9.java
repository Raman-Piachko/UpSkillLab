...
public class Task9 {
    ...
    private static double calculateSquareQuadrangle(double x, double y, double z, double t) {
        double square = 0;
    ...
    private static double calculateAngle(double x, double y, double z, double t) {
    ...
    private static double calculateRightTriangleSquare(double x, double y) {
        return (x * y) / 2;
    }

    private static double calculateTriangleSquare(double x, double y, double z, double t) {
        double hypotenuse = calculateHypotenuse(x, y);
    ...
    private static double calculateHalfPerimeterTriangle(double x, double y, double z, double t) {
        double hypotenuse = calculateHypotenuse(x, y);
